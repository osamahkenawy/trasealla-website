          ...
          <div className="col-xl-3 col-sm-6">
            ...
            >
              <div className="footer-logo mb-30">
                <Link href="/">
                  <img src="assets/images/logos/logo-white.svg" alt="Trasealla Solutions - Future Systems" />
                </Link>
              </div>
              ...
              <div className="info-item">
                ...
                <div className="content">
                  Need Any Help? <br />
                  Call :  <a href="tel:+971558446048">+971522200730</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="col-xl-3 col-sm-6">
            ...
            >
              <div className="footer-logo mb-30">
                <Link href="/">
                  <img
                    src="assets/images/logos/logo-full-white.svg"
